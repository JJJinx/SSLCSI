...
class VisionTransformer_CSI(_VisionTransformer):
    """Vision Transformer.
    ...
    def __init__(self,
                 ...
                 finetune=True,
                 **kwargs):
        super(VisionTransformer_CSI, self).__init__(init_cfg=init_cfg, **kwargs)
    ...
    def init_weights(self):
        super(VisionTransformer_CSI, self).init_weights()
    ...
    def train(self, mode=True):
        super(VisionTransformer_CSI, self).train(mode)
        self._freeze_stages()
