...
JOB_NAME='MoCov2'
CONFIG='/code/mmselfsup/configs/selfsup/mocov2/mocov2_resnet_8xb32-coslr-200e_csida.py'
CONFIG_VAL='/code/mmselfsup/configs/benchmarks/classification/csi_csida/sup_resnet_1xb64-coslr-100e.py'
CONFIG_TEST='/code/mmselfsup/configs/benchmarks/classification/csi_csida/sup_resnet_1xb64-coslr-100e.py'
SOURCE_DATA_DIR='/data/CSI_301'
SOURCE_TRAIN_DATA='/'
TARGET_DATA_DIR='/data/CSI_301'
TARGET_TRAIN_DATA='/'
TARGET_VAL_DATA='/'
TARGET_TEST_DATA='/'
DATA_SOURCE='CSIDA'
...
DATE=$(date "+%Y%m%d")
WORK_DIR='/output/mocov2_lr2e-5_resnet_adamw-coslr-150e_CSIDAp1_'${DATE}'/'
PORT='29500'
...
# model.backbone.frozen_stages=14  causual\
# ResNet frozen 4
