#!/bin/bash
JOB_NAME='MAE'
CONFIG='/code/mmselfsup/configs/selfsup/mae/mae_vit-base-p10_8xb512-coslr-400e_csida.py'
CONFIG_VAL='/code/mmselfsup/configs/benchmarks/classification/csi_csida/sup_vit-b_1xb64-coslr-100e.py'
CONFIG_TEST='/code/mmselfsup/configs/benchmarks/classification/csi_csida/sup_vit-b_1xb64-coslr-100e.py'
...
TARGET_VAL_DATA='/'
TARGET_TEST_DATA='/'
DATA_SOURCE='WiFi_CSIDA'

DATE=$(date "+%Y%m%d")
WORK_DIR='/output/mae-lr2e-4-adamw-StepFixcoslr-400e_CSIDAcon_'${DATE}'/'
